...
const cases = [
  ...
  },
  {
    ...
    accentColor: "#EC4899",
    metrics: [
      { label: "Mobile Conversions", before: "—", after: "+18%", icon: "📱" },
      { label: "Bounce Rate", before: "—", after: "−25%", icon: "📉" },
    ],
    description:
      "Nanobébé zanotował wzrost konwersji mobilnych o 18% i redukcję bounce rate o 25% po migracji na Next.js. Szybsze ładowanie na urządzeniach mobilnych okazało się kluczowe dla ich grupy docelowej.",
    highlights: [
